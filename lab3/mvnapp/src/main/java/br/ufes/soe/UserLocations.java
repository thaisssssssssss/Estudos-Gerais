...
public class UserLocations {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-totalwordcount");
       ...
       //Criando um "topology builder" para conseguir construir a nossa topologia
        ...
        KTable<String, Long> cityUserCounts = userLocations
        ...
        KStream<String, Long> cityUserCountsEvents = cityUserCounts
                .toStream()
                .peek((String key, Long value) -> System.out.println(key + ":" + value));
